...
const Page2 = () => {
  return (
    <div className="lg:px-4 px-1 	bg-[#191c20] " id="page2">
      <div
        className="lg:px-32 sm:px-2 bg-[#17191d] rounded-lg py-20  "
      >
        ...
        <p className="lg:text-2xl text-2xl  text-center pb-3">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-4 p-4 py-10 ">
          <div className="p-4 pr-8   border-gray-500 text-lg">
          ...
          <div className="p-4 pl-8 border-l border-gray-500 text-lg">
