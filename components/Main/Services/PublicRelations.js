  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 p-4 py-10 lg:px-32 px-4 bg-[#191C20]">
        ...
        <p className="py-1">
          {" "}
          Selecting the right media outlets, journalists are just the tip of the
          iceberg. Results are shown via the quality stories, interviews,
          opinionated articles by the company. With a strong foothold in the
          gaming media space, we believe no communication is complete without
          the appropriate strategy.
        </p>
        <p className="py-1">
          {" "}
          Apart from strategizing media content, the other ways of building
          thought leadership will be via conferences, webinars and conclave,
          awards, and recognition.{" "}
        </p>
        <p className="py-1">
          From corporate communication service offerings to brand building and
          perception and reputation management to crisis communication. We do it
          all.
        </p>
      </div>
        </div>
