...
const PublicRelations = () => {
  const data2 = [
    {
      title: "All the PR Tricks:",
      cont: "From getting the media excited to teaming up with cool influencers, and even handling those times when things get tricky – we've got a bag full of PR tricks. Our goal? Make your brand stand out, get those cool partnerships, and get more fans into your gaming world..",
    },
    {
      title: "Game Changers in Gaming PR:",
      cont: "We're not just saying it – we've actually played a big part in shaping the gaming PR scene in India. Our journey started from traditional gaming to the amazing world of Web3 and blockchain gaming.",
    },
    {
      title: "Looking Ahead:",
    ...
    {
      title: "More Than PR:",
      cont: "Sure, PR is our thing, but we're not stopping there. We're like the wizards of marketing, brand planning, and managing your rep. We're even pros at guiding gaming companies through tricky stuff like going public.",
    },
    {
    ...
    },
    {
      ...
      cont: "We're not like the usual PR folks. We're all about mixing classic PR with fresh, new ideas that rock the modern media scene. We're all about making you shine in the new media age.",
    },
    {
    ...
    {
      title:
        "Moram Napu is your go-to PR sidekick. Let us be the secret weapon that takes your gaming, Web3 gaming, and esports dreams to the stars. Give us a shout, and let's conquer the exciting gaming world together.",
    },
  ];
  const data = [
    {
      title: "Game-Changing PR for Gaming and Esports:",
      cont: "Our goal? Make your gaming brand a true powerhouse. Whether you're a gaming company looking to shine bright, an esports team aiming to build a fan club, or a game developer dreaming of fame, our PR tricks are all about you.",
    },
    {
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 pt-10  px-4 bg-[#eee2dc]">
            ...
            <div>
              <p className="py-1 text-[#123c69] text-[20px]">
                ...
                Napu is here to be more than just your average PR agency.
