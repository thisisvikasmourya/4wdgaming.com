        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 p-4   px-4 pt-10 bg-[#eee2dc]">
          ...
          <div>
            <p className="py-1 text-[#123c69] text-[20px]">
              Gaming is more than just playing; it&apos;s about making your brand
              shine. Our Growth Marketing services are like your brand&apos;s
              mentors, showing it the way through the gaming galaxy with
              strategies that gamers love.
            </p>
            {data.map((items, key) => (
              <div key={key}>
